        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="https://marsvista.dev/docs/quickstart"
              ...
              <li>
                <a
                  href="https://marsvista.dev/docs/guides/mars-time"
                  className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors text-sm"
                >
                  Guides
                </a>
              ...
              <li>
                <a
                  href="https://marsvista.dev/docs/reference/photos"
                  className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors text-sm"
                >
                  API Reference
                </a>
              ...
              <li>
                <a
                  href="https://marsvista.dev/docs/troubleshooting"
                  className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors text-sm"
                >
                  Troubleshooting
                </a>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://marsvista.dev/docs/llm/openapi.json"
                  className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors text-sm"
                >
                  OpenAPI Spec
                </a>
